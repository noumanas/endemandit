...
Strategist in the Middle East
          ...
          <button className="mt-10 bg-[#ABE03C] flex font-medium h-[60px] w-[359px] items-center justify-center rounded-lg text-[#102356]">
          Connect with a CRM Strategist
            <Image
              src={rightArrow}
              className="ml-2"
              height={14}
