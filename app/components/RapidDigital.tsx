    ...
    return(
        <div className="pt-9 lg:px-40">
            <div className="px-[20px] items-center flex flex-col lg:flex-row  justify-center">
                <div className="">
                    <h1 className="font-extrabold text-[36px] font-Inter text-[#ffffff] mt-20 lg:text-[72px]">Your Rapid Digital Transformation Partner</h1>
...
innovation, talent and reliability to the forefront.</p>
                ...
                <Image src={Imagecontainer2} alt="container" width={700} height={549} className="hidden lg:block mb-40 mt-20"/>
