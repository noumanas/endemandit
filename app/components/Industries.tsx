...
import publicsector from "../../public/assets/PublicSectorIcon.png";
import Insuranceicon from "../../public/assets/Insuranceicon.png";
import Bankingicon from "../../public/assets/Bankingicon.png";
import Manufacturingicon from "../../public/assets/Manufacturingicon.png";
import SupplyChainicon from "../../public/assets/SupplyChainicon.png";
import andmoreicon from "../../public/assets/andmoreicon.png";
        ...
        <div className="pt-9 lg:px-40">
            <div className="px-[20px] items-center flex flex-col lg:flex-row  justify-center lg:justify-center">
                <div className="text-center lg:text-left items-center flex flex-col justify-center lg:items-start ">
                    ...
                    <p className="text-[#102356] font-regular text-[12px] leading-[30px]">EnDemand IT caters to a diverse range of industries, including:</p>
                </div>
               
            </div>
            <div className="flex gap-[40px] pt-9 grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1  px-8">
            {data.map((item,index) => (
                       <div key={index} className={`group px-20 py-20 flex flex-col justify-center items-center gap-[10px] border-2 `}>
